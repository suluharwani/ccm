              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Forms <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="production/form.php">General Form</a></li>
    ...
    $(document).ready(function() {
        var table =   $('#user_data').DataTable({
            ...
            columns: [
                ...
                {
                    mRender: function (data, type, row) {
                        return '<button type="button" class="btn btn-sm btn-warning warning"  data-toggle="modal" data-target="#edit">EDIT</button>'
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">EDIT DATA: <i style="color: red;">sesuai nama peserta</i></h4>
          </div>
